...
HD_PWD='C:/Users/julia/DHBW/FPGA/Programmentwurf_VGA_exp_1/Programmentwurf_VGA_exp_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Ansteuerung_CLK.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_Ansteuerung_CLK.tcl -notrace
