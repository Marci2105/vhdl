...
HD_PWD='C:/Users/julia/DHBW/FPGA/Programmentwurf_VGA_exp_1/Programmentwurf_VGA_exp_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Ansteuerung_CLK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_Ansteuerung_CLK.tcl
